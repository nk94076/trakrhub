...
use App\Core\View;
?>
<h1 class="text-xl font-bold text-slate-900 mb-6">Sign in to your account</h1>
<form action="<?= View::url('admin/login') ?>" method="POST" class="space-y-4">
  <?= View::csrfField() ?>
  <div>
...
<div class="mt-4 text-center text-sm">
  <a href="<?= View::url('admin/forgot-password') ?>" class="text-brand-600 hover:underline">Forgot your password?</a>
</div>
