    ...
    <div class="row">
      <div class="col">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-9">
            <select class="form-control" name="redirect_type" id="redirectTypeSelect" onchange="document.getElementById('customUrlRow').style.display = this.value === 'custom' ? '' : 'none';">
              <?php foreach (['302' => '302', '302_hrf' => '302 with Hide Referrer', '200' => '200 OK', '200_hrf' => '200 with Hide Referrer', 'custom' => 'Custom (Set Referral Source)'] as $val => $label): ?>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-9">
            <input class="form-control" type="text" name="gclid_param" value="<?= htmlspecialchars($campaign['gclid_param'] ?? '') ?>" placeholder="e.g. subId1">
